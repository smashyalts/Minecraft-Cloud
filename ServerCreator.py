...
if not eula=="yes":
    ...
    command = "sudo apt-get update ; sudo apt-get -y install openjdk-17-jre-headless screen ; mkdir server ; cd server ; curl https://api.papermc.io/v2/projects/paper/versions/1.19.4/builds/527/downloads/paper-1.19.4-527.jar > server.jar ; echo eula = true > eula.txt ; sudo screen java -Xmx1G -jar server.jar ; op {}".format(adminuser)
